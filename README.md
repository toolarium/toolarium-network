...
[![Maven Central](https://img.shields.io/maven-central/v/com.github.toolarium/toolarium-network/1.0.1)](https://search.maven.org/artifact/com.github.toolarium/toolarium-network/1.0.1/jar)
...
```groovy
dependencies {
    implementation "com.github.toolarium:toolarium-network:1.0.1"
}
```
